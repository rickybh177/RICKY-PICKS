...
/* Overrides manuales, en orden de prioridad — misma semántica que
   ...
   TEMPORAL (11-sep-2026): partido fijado a mano por el dueño. Se salta
   a propósito la regla de "no regalar el partidazo". QUITAR cuando ya
   no se necesite. */
const OVERRIDES = [
  { league: 'ucl', home: 'Atlético', away: 'Man United', mercado: 'Ambos equipos anotan' },
];
