...
/* Overrides manuales, en orden de prioridad — misma semántica que
   ...
   TEMPORAL (14-sep-2026): fijado a mano por el dueño. QUITAR cuando ya
   no se necesite. El `mercado` lleva el ": NO" completo a propósito:
   con solo "ambos equipos anotan" también casaría el "SÍ". */
const OVERRIDES = [
  { league: 'epl', home: 'Man City', away: 'Sunderland', mercado: 'Ambos equipos anotan: NO' },
  { league: 'bundesliga', home: 'Stuttgart', away: 'Dortmund', mercado: 'Ambos equipos anotan: SÍ' },
  { league: 'ucl', home: 'Atlético', away: 'Man United', mercado: 'Gana Atlético' },
  /* Campaña: el pick gratis de LaLiga es el partido del Madrid, con
     "ambos anotan". Por `team` y no por matchup, para que siga al
     Madrid aunque cambie la jornada. */
  { league: 'laliga', team: 'Real Madrid', mercado: 'Ambos equipos anotan: SÍ' },
];
