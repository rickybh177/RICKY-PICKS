...
const PLANS = {
  ...
  /* Combo de los TRES modelos. Sustituye al combo MLB+Liga MX: los
     suscriptores que ya lo tenían ganan NFL sin pagar más (su cobro
     sigue al precio con el que se dieron de alta). El ancla es la
     suma real de los tres mensuales: 399 + 399 + 599 = 1,397. */
  combo_fundador: {
    id: 'combo_fundador',
    title: 'Combo 3 modelos — MLB + Liga MX + NFL',
    price: 799,       // MXN (suma de los tres por separado: 1,397)
    currency: 'MXN',
    days: 30,
    products: ['mlb', 'mx', 'nfl'],
    recurring: true,  // suscripción mensual (se re-cobra cada mes)
  ...
  nfl_fundador: {
    ...
    price: 599,       // MXN (ancla: 799) — incluye la pretemporada gratis
    currency: 'MXN',
    days: 30,
  ...
  nfl_temporada: {
    ...
    price: 1699,      // MXN (ancla: 2999) — incluye la pretemporada gratis
    currency: 'MXN',
