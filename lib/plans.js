...
const MONEDA_PASARELA = { stripe: 'USD', mercadopago: 'MXN' };
...
function precioDe(planId, ents, moneda) {
  const M = moneda === 'MXN' ? 'MXN' : 'USD';          // el sitio habla USD por defecto
  const def = PLANS[planId];
...
module.exports = { PLANS, USD, montoDe, MONEDA_PASARELA, founderPriceFor, FOUNDER_PLAN, upgradeSuscriptor, precioDe, UPGRADE_UN_MODELO, UPGRADE_TRES, ALL_MODELS, isChoosePlan, chooseCount, validChoice, isSubscription, isUpcoming, planCoversProduct, entitlementGrants, entitlementExpiry, coverageBeats, productsAlreadyCovered, comboPermanentDiscount, monthlyUpgradeFor, FULL_PASS_PLANS, EURO_PRODUCTS };
