...
const PLANS = {
  ...
  mlb_temporada: {
    ...
    price: 1399,      // MXN — pricing por suscripción 28-ago (≈4 meses de mensual); antes 599
    currency: 'MXN',
  ...
  mx_apertura: {
    ...
    price: 1399,      // MXN — pricing por suscripción 28-ago (≈4 meses de mensual); antes 699
    currency: 'MXN',
  ...
  nfl_temporada: {
    ...
    price: 1399,      // MXN — pricing por suscripción 28-ago (≈4 meses de mensual); antes 799
    currency: 'MXN',
...
const FULL_PASS_PLANS = ['mlb_temporada', 'mx_apertura', 'nfl_temporada', 'combo_2026'];

module.exports = { PLANS, isSubscription, planCoversProduct, entitlementGrants, comboPermanentDiscount, monthlyUpgradeFor, FULL_PASS_PLANS };
