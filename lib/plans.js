...
const PLANS = {
  ...
  /* Combo Total: los TRES modelos. Es el combo publicado. El ancla es
     la suma real de los tres mensuales: 399 + 399 + 599 = 1,397. */
  combo_total: {
    id: 'combo_total',
    title: 'Combo Total — MLB + Liga MX + NFL',
    price: 799,       // MXN (por separado: 1,397)
    currency: 'MXN',
    days: 30,
    products: ['mlb', 'mx', 'nfl'],
    recurring: true,  // suscripción mensual (se re-cobra cada mes)
