...
const PLANS = {
  ...
  mlb_temporada: {
    ...
    retired: true,    // 8-sep-2026: todo suscripción, ya no se venden pagos únicos; quien lo compró lo conserva (el upgrade $199 de los fundador se sigue honrando)
  ...
  /* ---- FÚTBOL EUROPEO: Premier League, LaLiga, Bundesliga y Champions ----
     ...
     todo suscripción. Las temporadas por liga (*_temporada) quedan
     cableadas pero NO a la venta (`upcoming`): ya no se venden pagos
     únicos. Precios espejados en checkout.html y meta-purchase.js.
...
module.exports = { PLANS, ALL_MODELS, isChoosePlan, chooseCount, validChoice, isSubscription, isUpcoming, planCoversProduct, entitlementGrants, entitlementExpiry, coverageBeats, productsAlreadyCovered, comboPermanentDiscount, monthlyUpgradeFor, FULL_PASS_PLANS, EURO_PRODUCTS };
