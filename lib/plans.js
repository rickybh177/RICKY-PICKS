...
const PLANS = {
  ...
  /* Combo 2026: los TRES modelos en pago único — el combo publicado.
     ...
     549 (MLB temporada) + 699 (MX apertura) + 799 (NFL temporada)
     = 2,047. days 365 cubre las tres temporadas completas (la última
     en terminar es la NFL, feb-2027). */
  combo_2026: {
    id: 'combo_2026',
    title: 'Combo Total — MLB + Liga MX + NFL (pago único)',
    price: 1199,      // MXN (por separado: 549+699+799 = 2,047)
    currency: 'MXN',
    days: 365,
    products: ['mlb', 'mx', 'nfl'],
    // PAGO ÚNICO: sin `recurring`. Nunca se cobra otra vez.
