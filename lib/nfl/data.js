...
/* 4-ago-2026: site.api.espn.com empezó a regresar 403 a IPs de
   datacenter (Vercel) con User-Agent no-navegador. El espejo
   site.web.api.espn.com sirve exactamente el mismo API y no
   bloquea; se usa como host primario y el clásico queda de
   respaldo. UA de navegador real en ambos. */
const ESPN = 'https://site.web.api.espn.com/apis/site/v2/sports/football/nfl';
const ESPN_FALLBACK = 'https://site.api.espn.com/apis/site/v2/sports/football/nfl';
